...
TESTS = tests/cyclic tests/random_binary tests/repeat_3_big_k tests/repeat_3_mid_k tests/repeat_3_small_k tests/repeat_3_big_sigma
...
all: main main-debug string-test string-test-debug naive tests

clean:
	rm main main-debug string-test string-test-debug naive tests/*[^.cpp]